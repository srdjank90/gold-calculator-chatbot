...
<script>
    jQuery(document).ready(function($) {
        ...
        // Prepare PHP variables for JS
        var gccPluginUrl = '<?php echo addslashes(GCC_PLUGIN_URL); ?>';
        var gccJqueryUrl = '<?php echo addslashes(includes_url('js/jquery/jquery.js')); ?>';
        ...
        $('#gcc-test-chatbot').on('click', function() {
            ...
            <html>
                <head>
                    ...
                    <link rel="stylesheet" href="${gccPluginUrl}assets/css/chatbot.css">
                </head>
                <body>
                    ...
                    <script src="${gccJqueryUrl}"></` + `script>
                    <script src="${gccPluginUrl}assets/js/chatbot.js"></` + `script>
                </body>
            </html>
        `);
        });
