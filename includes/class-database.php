...
class GCC_Database
{
    ...
    private function insert_sample_products()
    {
        ...
        $sample_products = array(
            ...
            array(
                'name' => 'Smartpack zlatne pločice 10g (10x1g)',
            ...
            array(
                'name' => 'Smartpack zlatne pločice 20g (10x2g)',
    ...
    private function insert_default_personas()
    {
        ...
        if ($added_count > 0) {
            // Added default personas on activation
        }
    }
    ...
    private function insert_default_questions()
    {
        ...
        if ($added_count > 0) {
            // Added default questions on activation
        }
    }
